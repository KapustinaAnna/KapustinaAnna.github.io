...
**`NFPER1`** Система должна иметь возможность обслуживать не менее 30 пользователей одновременно в период пиковой активности с 08:00 до 20:00 по местному времени
...
**`NFPER3`** Приложение должно обеспечить бесперебойную работу всех остальных функций во время инвентаризации, позволяя одновременно обрабатывать до 10,000 единиц товаров без значительного снижения производительности.
...
**`NFEXT1`**  Система должна позволять увеличение производительности за счёт увеличения вычислительной мощности и ресурсов со стороны оборудования.
...
**`NFCOM1`**  Мобильное приложение должно быть совместимо с ОС Android 7.0 или выше и iOS 13 или выше.

**`NFCOM2`** Веб-приложение должно быть кросс-браузерным.
...
**`NFARC1`**  Все элементы пользовательского интерфейса должны следовать единому стилю, цветовой палитре и шрифтам, предлагая пользователям понятное и предсказуемое взаимодействие.
...
|Основной сценарий|<p>1. Пользователь создает новый процесс инвентаризации</p><p>2. Пользователь сканирует штрихкод продукта.</p><p>3. Система показывает информацию по продукту</p><p>4. Пользователь сверяет информацию</p><p>5. Если информация верная, пользователь переходит к проверке следующего продукта </p><p>Конец сценария,когда все продукты проверены</p>|
|Альтернативный сценарий|<p>**Продукт не найден**</p><p>3А. Система выдает ошибку, что продукт не найден </p><p>1. Пользователь добавляет информация о продукте в систему</p><p>&emsp;</p><p>**Некорректная информация в системе**</p><p></p><p>4А. Если информация некорректная:</p><p>1. Пользователь вносит правки</p><p>2. Пользователь сохраняет новую информацию</p><p>   </p><p></p>|
